	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001e5:	0f be 80 e8 0d 80 00 	movsbl 0x800de8(%eax),%eax
  8001ec:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003b0:	50                   	push   %eax
  8003b1:	68 00 0e 80 00       	push   $0x800e00
  8003b6:	53                   	push   %ebx
  8003b7:	56                   	push   %esi
  ...
  8003c8:	52                   	push   %edx
  8003c9:	68 09 0e 80 00       	push   $0x800e09
  8003ce:	53                   	push   %ebx
  8003cf:	56                   	push   %esi
  ...
  8003f6:	ba f9 0d 80 00       	mov    $0x800df9,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800adc:	e8 0a f6 ff ff       	call   8000eb <vcprintf>
	cprintf("\n");
  800ae1:	c7 04 24 dc 0d 80 00 	movl   $0x800ddc,(%esp)
