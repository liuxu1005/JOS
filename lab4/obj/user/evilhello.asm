...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800329:	56                   	push   %esi
  80032a:	50                   	push   %eax
  80032b:	68 b8 0f 80 00       	push   $0x800fb8
  ...
  80033c:	e8 54 00 00 00       	call   800395 <vcprintf>
	cprintf("\n");
  800341:	c7 04 24 dc 0f 80 00 	movl   $0x800fdc,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80048f:	0f be 80 de 0f 80 00 	movsbl 0x800fde(%eax),%eax
  800496:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80065a:	50                   	push   %eax
  80065b:	68 f6 0f 80 00       	push   $0x800ff6
  800660:	53                   	push   %ebx
  800661:	56                   	push   %esi
  ...
  800672:	52                   	push   %edx
  800673:	68 ff 0f 80 00       	push   $0x800fff
  800678:	53                   	push   %ebx
  800679:	56                   	push   %esi
  ...
  8006a0:	ba ef 0f 80 00       	mov    $0x800fef,%edx
