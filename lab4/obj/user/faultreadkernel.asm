	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001e2:	0f be 80 b1 0f 80 00 	movsbl 0x800fb1(%eax),%eax
  8001e9:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002de:	ff 24 85 80 10 80 00 	jmp    *0x801080(,%eax,4)
  ...
  8003a2:	8b 14 85 e0 11 80 00 	mov    0x8011e0(,%eax,4),%edx
  8003a9:	85 d2                	test   %edx,%edx
  8003ab:	75 18                	jne    8003c5 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003ad:	50                   	push   %eax
  8003ae:	68 c9 0f 80 00       	push   $0x800fc9
  8003b3:	53                   	push   %ebx
  8003b4:	56                   	push   %esi
  ...
  8003c5:	52                   	push   %edx
  8003c6:	68 d2 0f 80 00       	push   $0x800fd2
  8003cb:	53                   	push   %ebx
  8003cc:	56                   	push   %esi
  ...
  8003f3:	ba c2 0f 80 00       	mov    $0x800fc2,%edx
...
sys_env_destroy(envid_t envid)
{
  ...
  800a72:	68 08 12 80 00       	push   $0x801208
  800a77:	6a 23                	push   $0x23
  800a79:	68 25 12 80 00       	push   $0x801225
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800af3:	68 08 12 80 00       	push   $0x801208
  800af8:	6a 23                	push   $0x23
  800afa:	68 25 12 80 00       	push   $0x801225
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b35:	68 08 12 80 00       	push   $0x801208
  800b3a:	6a 23                	push   $0x23
  800b3c:	68 25 12 80 00       	push   $0x801225
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b77:	68 08 12 80 00       	push   $0x801208
  800b7c:	6a 23                	push   $0x23
  800b7e:	68 25 12 80 00       	push   $0x801225
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bb9:	68 08 12 80 00       	push   $0x801208
  800bbe:	6a 23                	push   $0x23
  800bc0:	68 25 12 80 00       	push   $0x801225
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800bfb:	68 08 12 80 00       	push   $0x801208
  800c00:	6a 23                	push   $0x23
  800c02:	68 25 12 80 00       	push   $0x801225
...
sys_ipc_recv(void *dstva)
{
  ...
  800c5f:	68 08 12 80 00       	push   $0x801208
  800c64:	6a 23                	push   $0x23
  800c66:	68 25 12 80 00       	push   $0x801225
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c94:	56                   	push   %esi
  800c95:	50                   	push   %eax
  800c96:	68 34 12 80 00       	push   $0x801234
  ...
  800ca7:	e8 3c f4 ff ff       	call   8000e8 <vcprintf>
	cprintf("\n");
  800cac:	c7 04 24 58 12 80 00 	movl   $0x801258,(%esp)
