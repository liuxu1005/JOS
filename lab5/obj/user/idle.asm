...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 00 	movl   $0x801e00,0x803000
  800040:	1e 80 00 
...
sys_env_destroy(envid_t envid)
{
  ...
  80010f:	68 0f 1e 80 00       	push   $0x801e0f
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800190:	68 0f 1e 80 00       	push   $0x801e0f
  800195:	6a 23                	push   $0x23
  800197:	68 2c 1e 80 00       	push   $0x801e2c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d2:	68 0f 1e 80 00       	push   $0x801e0f
  8001d7:	6a 23                	push   $0x23
  8001d9:	68 2c 1e 80 00       	push   $0x801e2c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800214:	68 0f 1e 80 00       	push   $0x801e0f
  800219:	6a 23                	push   $0x23
  80021b:	68 2c 1e 80 00       	push   $0x801e2c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800256:	68 0f 1e 80 00       	push   $0x801e0f
  80025b:	6a 23                	push   $0x23
  80025d:	68 2c 1e 80 00       	push   $0x801e2c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800298:	68 0f 1e 80 00       	push   $0x801e0f
  80029d:	6a 23                	push   $0x23
  80029f:	68 2c 1e 80 00       	push   $0x801e2c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002da:	68 0f 1e 80 00       	push   $0x801e0f
  8002df:	6a 23                	push   $0x23
  8002e1:	68 2c 1e 80 00       	push   $0x801e2c
...
sys_ipc_recv(void *dstva)
{
  ...
  80033e:	68 0f 1e 80 00       	push   $0x801e0f
  800343:	6a 23                	push   $0x23
  800345:	68 2c 1e 80 00       	push   $0x801e2c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80042c:	ba b8 1e 80 00       	mov    $0x801eb8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800457:	51                   	push   %ecx
  800458:	50                   	push   %eax
  800459:	68 3c 1e 80 00       	push   $0x801e3c
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80080b:	53                   	push   %ebx
  80080c:	50                   	push   %eax
  80080d:	68 5c 1e 80 00       	push   $0x801e5c
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a94:	68 c8 1e 80 00       	push   $0x801ec8
  800a99:	68 cf 1e 80 00       	push   $0x801ecf
  800a9e:	6a 7c                	push   $0x7c
  800aa0:	68 e4 1e 80 00       	push   $0x801ee4
  800aa5:	e8 ba 05 00 00       	call   801064 <_panic>
	assert(r <= PGSIZE);
  800aaa:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800aaf:	7e 16                	jle    800ac7 <devfile_read+0x65>
  800ab1:	68 ef 1e 80 00       	push   $0x801eef
  800ab6:	68 cf 1e 80 00       	push   $0x801ecf
  800abb:	6a 7d                	push   $0x7d
  800abd:	68 e4 1e 80 00       	push   $0x801ee4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ba0:	68 fb 1e 80 00       	push   $0x801efb
  800ba5:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800c4e:	52                   	push   %edx
  800c4f:	53                   	push   %ebx
  800c50:	68 02 1f 80 00       	push   $0x801f02
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ef1:	68 1a 1f 80 00       	push   $0x801f1a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801080:	56                   	push   %esi
  801081:	50                   	push   %eax
  801082:	68 28 1f 80 00       	push   $0x801f28
  ...
  801093:	e8 54 00 00 00       	call   8010ec <vcprintf>
	cprintf("\n");
  801098:	c7 04 24 13 1f 80 00 	movl   $0x801f13,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8011e6:	0f be 80 4b 1f 80 00 	movsbl 0x801f4b(%eax),%eax
  8011ed:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8013b1:	50                   	push   %eax
  8013b2:	68 63 1f 80 00       	push   $0x801f63
  8013b7:	53                   	push   %ebx
  8013b8:	56                   	push   %esi
  ...
  8013c9:	52                   	push   %edx
  8013ca:	68 e1 1e 80 00       	push   $0x801ee1
  8013cf:	53                   	push   %ebx
  8013d0:	56                   	push   %esi
  ...
  8013f7:	ba 5c 1f 80 00       	mov    $0x801f5c,%edx
