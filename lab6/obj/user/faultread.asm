	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ea:	0f be 80 68 23 80 00 	movsbl 0x802368(%eax),%eax
  8001f1:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003b5:	50                   	push   %eax
  8003b6:	68 80 23 80 00       	push   $0x802380
  8003bb:	53                   	push   %ebx
  8003bc:	56                   	push   %esi
  ...
  8003fb:	ba 79 23 80 00       	mov    $0x802379,%edx
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801f15:	e8 d6 e1 ff ff       	call   8000f0 <vcprintf>
	cprintf("\n");
  801f1a:	c7 04 24 5c 23 80 00 	movl   $0x80235c,(%esp)
