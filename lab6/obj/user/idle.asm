...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 40 	movl   $0x802340,0x803000
  800040:	23 80 00 
...
sys_env_destroy(envid_t envid)
{
  ...
  80010f:	68 4f 23 80 00       	push   $0x80234f
  800114:	6a 22                	push   $0x22
  800116:	68 6c 23 80 00       	push   $0x80236c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800190:	68 4f 23 80 00       	push   $0x80234f
  800195:	6a 22                	push   $0x22
  800197:	68 6c 23 80 00       	push   $0x80236c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d2:	68 4f 23 80 00       	push   $0x80234f
  8001d7:	6a 22                	push   $0x22
  8001d9:	68 6c 23 80 00       	push   $0x80236c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800214:	68 4f 23 80 00       	push   $0x80234f
  800219:	6a 22                	push   $0x22
  80021b:	68 6c 23 80 00       	push   $0x80236c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800256:	68 4f 23 80 00       	push   $0x80234f
  80025b:	6a 22                	push   $0x22
  80025d:	68 6c 23 80 00       	push   $0x80236c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800298:	68 4f 23 80 00       	push   $0x80234f
  80029d:	6a 22                	push   $0x22
  80029f:	68 6c 23 80 00       	push   $0x80236c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002da:	68 4f 23 80 00       	push   $0x80234f
  8002df:	6a 22                	push   $0x22
  8002e1:	68 6c 23 80 00       	push   $0x80236c
...
{  
  ...
  80033e:	68 4f 23 80 00       	push   $0x80234f
  800343:	6a 22                	push   $0x22
  800345:	68 6c 23 80 00       	push   $0x80236c
...
sys_transmit(void *addr)
{
  ...
  80039e:	68 4f 23 80 00       	push   $0x80234f
  8003a3:	6a 22                	push   $0x22
  8003a5:	68 6c 23 80 00       	push   $0x80236c
...
sys_recv(void *addr)
{
  ...
  8003df:	68 4f 23 80 00       	push   $0x80234f
  8003e4:	6a 22                	push   $0x22
  8003e6:	68 6c 23 80 00       	push   $0x80236c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8004e7:	8b 04 95 f8 23 80 00 	mov    0x8023f8(,%edx,4),%eax
  ...
  8004fd:	51                   	push   %ecx
  8004fe:	50                   	push   %eax
  8004ff:	68 7c 23 80 00       	push   $0x80237c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80072b:	53                   	push   %ebx
  80072c:	50                   	push   %eax
  80072d:	68 bd 23 80 00       	push   $0x8023bd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007fc:	53                   	push   %ebx
  8007fd:	50                   	push   %eax
  8007fe:	68 d9 23 80 00       	push   $0x8023d9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8008b1:	53                   	push   %ebx
  8008b2:	50                   	push   %eax
  8008b3:	68 9c 23 80 00       	push   $0x80239c
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800b3a:	68 0c 24 80 00       	push   $0x80240c
  800b3f:	68 13 24 80 00       	push   $0x802413
  800b44:	6a 7c                	push   $0x7c
  800b46:	68 28 24 80 00       	push   $0x802428
  800b4b:	e8 2b 0a 00 00       	call   80157b <_panic>
	assert(r <= PGSIZE);
  800b50:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800b55:	7e 16                	jle    800b6d <devfile_read+0x65>
  800b57:	68 33 24 80 00       	push   $0x802433
  800b5c:	68 13 24 80 00       	push   $0x802413
  800b61:	6a 7d                	push   $0x7d
  800b63:	68 28 24 80 00       	push   $0x802428
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c34:	68 3f 24 80 00       	push   $0x80243f
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  800fe4:	68 4b 24 80 00       	push   $0x80244b
  800fe9:	68 13 24 80 00       	push   $0x802413
  800fee:	6a 62                	push   $0x62
  800ff0:	68 60 24 80 00       	push   $0x802460
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801031:	68 6c 24 80 00       	push   $0x80246c
  801036:	68 13 24 80 00       	push   $0x802413
  80103b:	6a 6d                	push   $0x6d
  80103d:	68 60 24 80 00       	push   $0x802460
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8010b7:	68 78 24 80 00       	push   $0x802478
  8010bc:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801165:	52                   	push   %edx
  801166:	53                   	push   %ebx
  801167:	68 7f 24 80 00       	push   $0x80247f
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801408:	68 97 24 80 00       	push   $0x802497
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801597:	56                   	push   %esi
  801598:	50                   	push   %eax
  801599:	68 a4 24 80 00       	push   $0x8024a4
  ...
  8015aa:	e8 54 00 00 00       	call   801603 <vcprintf>
	cprintf("\n");
  8015af:	c7 04 24 90 24 80 00 	movl   $0x802490,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8016fd:	0f be 80 c7 24 80 00 	movsbl 0x8024c7(%eax),%eax
  801704:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8018c8:	50                   	push   %eax
  8018c9:	68 df 24 80 00       	push   $0x8024df
  8018ce:	53                   	push   %ebx
  8018cf:	56                   	push   %esi
  ...
  8018e0:	52                   	push   %edx
  8018e1:	68 25 24 80 00       	push   $0x802425
  8018e6:	53                   	push   %ebx
  8018e7:	56                   	push   %esi
  ...
  80190e:	ba d8 24 80 00       	mov    $0x8024d8,%edx
